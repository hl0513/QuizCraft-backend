package com.hhj.quizCraft.service.impl;
...
import com.hhj.quizCraft.mapper.AppMapper;
import com.hhj.quizCraft.model.dto.app.AppQueryRequest;
import com.hhj.quizCraft.model.entity.App;
import com.hhj.quizCraft.model.entity.User;
import com.hhj.quizCraft.model.enums.AppScoringStrategyEnum;
import com.hhj.quizCraft.model.enums.AppTypeEnum;
import com.hhj.quizCraft.model.enums.ReviewStatusEnum;
import com.hhj.quizCraft.model.vo.AppVO;
import com.hhj.quizCraft.model.vo.UserVO;
import com.hhj.quizCraft.service.AppService;
import com.hhj.quizCraft.service.UserService;
import com.hhj.quizCraft.utils.SqlUtils;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public void validApp(App app, boolean add) {
        ...
        if (add) {
            ...
            ThrowUtils.throwIf(appTypeEnum == null, ErrorCode.PARAMS_ERROR, "请添加正确的应用类型");
            AppScoringStrategyEnum appScoringStrategyEnum = AppScoringStrategyEnum.getEnumByValue(scoringStrategy);
            ThrowUtils.throwIf(appScoringStrategyEnum == null, ErrorCode.PARAMS_ERROR, "请添加正确的计分策略");
        }
        // 修改数据时，有参数则校验
        //  补充校验规则
        if (StringUtils.isNotBlank(appName)) {
            ThrowUtils.throwIf(appName.length() > 80, ErrorCode.PARAMS_ERROR, "应用名称不要超过80");
        }
        if (StringUtils.isNotBlank(appDesc)) {
            ThrowUtils.throwIf(appDesc.length() > 500, ErrorCode.PARAMS_ERROR, "应用描述不要超过500");
        }
