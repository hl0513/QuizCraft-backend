...
import com.hhj.quizCraft.common.*;
...
import com.hhj.quizCraft.model.dto.app.AppAddRequest;
import com.hhj.quizCraft.model.dto.app.AppEditRequest;
import com.hhj.quizCraft.model.dto.app.AppQueryRequest;
import com.hhj.quizCraft.model.dto.app.AppUpdateRequest;
...
public class AppController {
    ...
    public BaseResponse<Boolean> doAppReview(@RequestBody ReviewRequest reviewRequest,HttpServletRequest request){
        ...
        if (reviewStatusEnum == null || id == null){
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
        // 判断是否存在
        App oldApp = appService.getById(id);
        ...
        if(oldApp.getReviewStatus().equals(reviewStatus)){
            throw new BusinessException(ErrorCode.OPERATION_ERROR, "已处于该状态,请勿重复审核");
        }
        // 更新审核状态
        User loginUser = userService.getLoginUser(request);
        App app = new App();
